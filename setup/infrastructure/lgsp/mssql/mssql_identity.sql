USE master
GO
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'WSO2_IDENTITY_DB')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.database_principals WHERE name = N'wso2carbon')
BEGIN
    CREATE USER [wso2carbon] FOR LOGIN [wso2carbon]
    EXEC sp_addrolemember N'db_owner', N'wso2carbon'
END;
GO
...
INSERT INTO IDN_BASE_TABLE values ('PRODUCT_NAME');
